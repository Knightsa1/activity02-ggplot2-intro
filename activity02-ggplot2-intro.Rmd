...
bill_length_mm- factor denoting bill length (millimeters)
bill_depth_mm - a number denoting bill depth (millimeters)
flipper_length_mm- a number denoting flipper length (millimeters)
body_mass_g- an integer denoting body mass (grams)
sex- a factor denoting penguin sex
yer- an integer denoting the study year
